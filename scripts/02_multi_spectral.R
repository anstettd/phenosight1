...
for(var in response_vars) {
  ...
  p1 <- results %>%
    ...
    labs(x = "Hours of Imaging", y = "", title = paste(var, "Early")) +
    theme_bw() + theme(
  ...
  ggsave(paste0("graphs/multi-spectral/p-val/", tolower(var), "_early_p_val.pdf"),
  ...
  p2 <- PS2_early3 %>%
    ...
    labs(x = "Time of Experiment", y = paste(var, "early")) +
    theme_bw() + theme(
      axis.text.x = element_text(size = 16, face = "bold", hjust = 0.4),
      axis.text.y = element_text(size = 16, face = "bold"),
      axis.title.x = element_text(color = "black", size = 20, vjust = 0.5, face = "bold"),
  ...
  ggsave(paste0("graphs/multi-spectral/all_treatments/", tolower(var), "_early_all.pdf"),
         plot = p2, width = 10, height = 16, units = "in")
  ...
  ggsave(paste0("graphs/multi-spectral/20_treatment/", tolower(var), "_early_20.pdf"),
         plot = p3, width = 8, height = 6, units = "in")
  
  message("Done early: ", var)
}
...
for(var in response_vars) {
  ...
  p1 <- results %>%
    ...
    labs(x = "Hours of Imaging", y = "", title = paste(var, "Late")) +
    theme_bw() + theme(
      plot.title = element_text(size = 20, face = "bold", hjust = 0.5),
      axis.text.x = element_text(size = 16, face = "bold", hjust = 0.4),
      axis.text.y = element_text(size = 16, face = "bold"),
  ...
  ggsave(paste0("graphs/multi-spectral/p-val/", tolower(var), "_late_p_val.pdf"),
         plot = p1, width = 6, height = 8, units = "in")
  ...
  p2 <- PS2_late3 %>%
    ...
    facet_grid(Treatment ~ Site,
               labeller = labeller(Site = c("Oregon" = "Oregon", "SCalifornia" = "Southern California"))) +
    labs(x = "Time of Experiment", y = paste(var, "late")) +
    theme_bw() + theme(
      axis.text.x = element_text(size = 16, face = "bold", hjust = 0.4),
      axis.text.y = element_text(size = 16, face = "bold"),
      axis.title.x = element_text(color = "black", size = 20, vjust = 0.5, face = "bold"),
  ...
  ggsave(paste0("graphs/multi-spectral/all_treatments/", tolower(var), "_late_all.pdf"),
         plot = p2, width = 10, height = 16, units = "in")
  ...
  ggsave(paste0("graphs/multi-spectral/20_treatment/", tolower(var), "_late_20.pdf"),
         plot = p3, width = 8, height = 6, units = "in")
  
  message("Done late: ", var)
}
...
files_20 <- list.files("graphs/multi-spectral/20_treatment/", 
                       pattern = "\\.pdf$", full.names = TRUE)
pdf_combine(files_20, output = "graphs/multi-spectral/20_treatment_booklet.pdf")

# --- all treatments booklet ---
files_all <- list.files("graphs/multi-spectral/all_treatments/", 
                        pattern = "\\.pdf$", full.names = TRUE)
pdf_combine(files_all, output = "graphs/multi-spectral/all_treatments_booklet.pdf")

# --- p-val booklet ---
files_pval <- list.files("graphs/multi-spectral/p-val/", 
                         pattern = "\\.pdf$", full.names = TRUE)
pdf_combine(files_pval, output = "graphs/multi-spectral/p_val_booklet.pdf")